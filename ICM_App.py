...
<div style='text-align:center'>
    <h1 style='color:#B87333;'>Industrial Copper Modeling Application</h1>
</div>
...
with tab1:    
        ...
        with st.form("my_form"):
            ...
            with col3:               
                ...
                thickness = st.text_input("Enter thickness (Min:0.18 to Max:400)")
                width = st.text_input("Enter width (Min:1 to Max:2990)")
                customer = st.text_input("customer ID (Min:12458 to Max:30408185)")
...
st.write( f'<h6 style="color:rgb(0, 153, 153,0.35);">App Created by Tamiz Hari</h6>', unsafe_allow_html=True )  
